...
def train_loop():
    ds = GraphStructureDataset5(data_dir=__import__("config").DATA_DIR)
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        from config import (W_BCE, W_TIME, W_TOTALT, W_LONGEST, W_DAG, W_DEG_COV, W_SRC_SINK_SOFT, W_TIME_NODE)
